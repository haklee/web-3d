        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300 text-lg">
              A 3D web project created on April 11, 2025
            </p>
          </div>
          ...
          <div className="border border-gray-200 dark:border-gray-700 rounded-2xl p-8 bg-white dark:bg-gray-800 shadow-sm">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <ul className="text-gray-600 dark:text-gray-300 space-y-2">
                <li>• Adjust the number of points using the slider</li>
                <li>• Change the random seed to generate different point distributions</li>
                <li>• Points are generated using the Halton sequence for optimal distribution</li>
              </ul>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-6 bg-white dark:bg-gray-800">
              ...
              <ul className="space-y-2 text-gray-600 dark:text-gray-300">
                <li>Created: April 11, 2025</li>
                <li>Type: 2D Visualization</li>
