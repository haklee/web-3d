        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300 text-lg">
              A 3D web project created on April 21, 2025
            </p>
          </div>
          ...
          <div className="border border-gray-200 dark:border-gray-700 rounded-2xl p-8 bg-white dark:bg-gray-800 shadow-sm">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <ul className="text-gray-600 dark:text-gray-300 space-y-2">
                <li>• Watch the pixels change color randomly</li>
                <li>• Each pixel updates independently</li>
                <li>• The animation runs at 60 FPS</li>
                <li>• Colors are generated using HSL color space</li>
              </ul>
            </div>
          </div>
