        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300 text-lg">
              A 3D web project created on April 4, 2025
            </p>
          </div>
          ...
          <div className="border border-gray-200 dark:border-gray-700 rounded-2xl p-8 bg-white dark:bg-gray-800 shadow-sm">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <ul className="text-gray-600 dark:text-gray-300 space-y-2">
                <li>• Click on any cube to make it explode</li>
                <li>• Exploded cubes will regenerate after 2 seconds</li>
                <li>• Regenerated cubes may have different colors</li>
                <li>• View is fixed in isometric perspective</li>
              </ul>
            </div>
          </div>
